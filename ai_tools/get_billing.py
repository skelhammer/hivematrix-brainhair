...
Usage:
    ...
    python ai_tools/get_billing.py "Green Diamond"
    python ai_tools/get_billing.py 276292
"""
...
def main():
    if len(sys.argv) < 2:
        ...
        print("Example: python get_billing.py 'Green Diamond'")
        print("Example: python get_billing.py 276292")
        sys.exit(1)
