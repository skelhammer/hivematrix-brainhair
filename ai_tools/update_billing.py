...
Usage:
    ...
    python update_billing.py 276292 --per-user 125 --per-server 125 --per-workstation 0
    python update_billing.py "Green Diamond" --line-item "Network Management" 200
"""
...
def main():
    ...
    parser.add_argument('--billing-plan', type=str,
                        choices=['MSP Basic', 'MSP Advanced', 'MSP Premium', 'MSP Platinum',
