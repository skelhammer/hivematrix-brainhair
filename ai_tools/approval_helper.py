...
def request_approval(action: str, details: dict, timeout: int = 120) -> bool:
    ...
    Args:
        ...
        details: Dict with details to show user (e.g., {'company': 'Green Diamond', 'old_value': '$125', 'new_value': '$100'})
    ...
    Example:
        >>> if request_approval("Update per-user cost", {'company': 'Green Diamond', 'from': '$125', 'to': '$100'}):
        >>>     # Make the change
        >>>     pass
        >>> else:
