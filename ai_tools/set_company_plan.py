...
Usage:
    ...
    python set_company_plan.py "Green Diamond" "MSP Platinum" "2-Year"
    python set_company_plan.py 276292 "MSP Premium" "Month to Month"

Available Plans: Break Fix, MSP Basic, MSP Advanced, MSP Premium, MSP Platinum, MSP Legacy, MSP Network, Pro Services
...
def main():
    if len(sys.argv) < 4:
        ...
        print("Example: python set_company_plan.py 'Green Diamond' 'MSP Platinum' '2-Year'")
        print("\nAvailable Plans: Break Fix, MSP Basic, MSP Advanced, MSP Premium, MSP Platinum, MSP Legacy, MSP Network, Pro Services")
