...
Usage:
    ...
    python ai_tools/update_features.py "Green Diamond" --soc "RocketCyber" --antivirus "Webroot"
    python ai_tools/update_features.py 276292 --password-manager "Keeper" --sat "Datto SAT"
    python ai_tools/update_features.py "Green Diamond" --list
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python ai_tools/update_features.py "Green Diamond" --antivirus "SentinelOne"
  python ai_tools/update_features.py 276292 --soc "RocketCyber" --password-manager "Keeper"
  python ai_tools/update_features.py "Green Diamond" --list
