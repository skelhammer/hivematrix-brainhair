class PrefixMiddleware:
    ...
    http://nexus:8000/brainhair/ -> http://brainhair:5050/

    NOTE: This middleware is not currently in use. Brainhair uses werkzeug.middleware.proxy_fix.ProxyFix
    instead, which is the more modern and recommended approach for handling X-Forwarded headers
    from reverse proxies. This file exists for consistency with other HiveMatrix services.
    """
