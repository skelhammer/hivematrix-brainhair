"""
Service-to-Service Authentication Helper for HiveMatrix (Option 1: Centralized)

Add this to each service that needs to call other services.
Usage:
    from app.service_client import call_service

    response = call_service('template', '/api/data')
    # or
...
def call_service(service_name, path, method='GET', **kwargs):
    ...
    Args:
        service_name: The target service name (e.g., 'template', 'codex')
